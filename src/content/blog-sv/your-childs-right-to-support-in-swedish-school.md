...
1. **Ledning och stimulans, basen varje elev får.** God, anpassad undervisning för alla är grunden hela systemet vilar på ([vad ledning och stimulans betyder](/sv/blog/what-is-ledning-och-stimulans)), inom [en tillgänglig lärmiljö](/sv/blog/what-is-an-accessible-learning-environment).
2. **Extra anpassningar, de vardagliga justeringarna.** När basen inte räcker måste läraren sätta in mindre justeringar inom den ordinarie undervisningen, snabbt, utan något formellt beslut ([hur extra anpassningar ser ut](/sv/blog/what-do-extra-anpassningar-look-like)). Den juridiska gränsen mellan den här nivån och nästa beskrivs i [vad skollagen kräver](/sv/blog/what-skollagen-requires-extra-anpassningar-sarskilt-stod).
3. **Särskilt stöd, den formella nivån.** Om extra anpassningar inte räcker måste rektorn inleda en utredning av barnets behov av särskilt stöd ([utredningen bakom särskilt stöd](/sv/blog/the-utredning-behind-sarskilt-stod)). Om ett behov konstateras skriver skolan ett [åtgärdsprogram, och det finns regler för vad det måste innehålla](/sv/blog/what-an-atgardsprogram-must-contain).

## De rutinmässiga avstämningarna

Du behöver inte vänta på en kris för att ta upp en oro. Två gånger om året har varje elev ett [utvecklingssamtal](/sv/blog/what-is-an-utvecklingssamtal), ett möte som lagen gör till ett samtal om hur skolan bäst kan stödja ditt barn och vilket stöd som behövs. Det är en av dina bästa rutinmässiga chanser att förvandla en oro till en plan, om du går in förberedd ([så förbereder du dig inför mötet](/sv/blog/how-to-prepare-for-your-childs-utvecklingssamtal)).

## När stödet uteblir

Det svåraste är när rätten är tydlig och hjälpen ändå inte kommer. Det är ingen återvändsgränd. Verktygen är fastslagna:

- **Hela eskaleringsvägen**, från att ta upp det med rektorn till utredningen till det formella beslutet, beskrivs i vår [guide för när ett barn inte får det stöd det behöver](/sv/blog/parent-guide-child-not-getting-support-at-school).
- **Du kan överklaga.** Ett beslut om särskilt stöd kan prövas ([så överklagar du ett beslut om särskilt stöd](/sv/blog/how-to-appeal-a-sarskilt-stod-decision)).
- **Du kan anmäla skolan.** Om den brister i sin skyldighet kan du vända dig till inspektionen ([så anmäler du en skola till Skolinspektionen](/sv/blog/how-to-report-a-school-to-skolinspektionen)).
- **Att inte anpassa kan vara diskriminering.** Att neka rimligt stöd kan gå över i olaglig diskriminering, inte bara dålig praxis ([när utebliven anpassning blir diskriminering](/sv/blog/failing-to-support-npf-student-can-be-discrimination)).
