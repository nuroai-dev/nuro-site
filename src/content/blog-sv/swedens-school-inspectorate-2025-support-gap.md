...
[Rätten till det stödet är inskriven i skollagen](/sv/blog/what-skollagen-requires-extra-anpassningar-sarskilt-stod). [Om skolorna har resurserna att leverera det är ett separat, dokumenterat problem](/sv/blog/principals-say-they-lack-resources-for-npf). Det inspektionen lägger till är domen: efter år av granskning når det stöd lagen lovar inte tillförlitligt fram till de elever som har rätt till det.
