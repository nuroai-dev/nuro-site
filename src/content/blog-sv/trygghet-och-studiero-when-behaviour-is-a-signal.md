---
title: "Trygghet och studiero: när en elev stör upprepat säger lagen utred, inte bara bestraffa"
...
Läs den korshänvisningen en gång till. Beteendekapitlet pekar rakt på stödkapitlet. Lagen låter inte en skola behandla upprepad störning som enbart ett ordningsproblem. Den kräver att skolan frågar sig om beteendet är ett tecken på ett behov som inte tillgodoses, och i så fall inleder just den [utredning som avgör särskilt stöd](/sv/blog/the-utredning-behind-sarskilt-stod). Disciplin och stöd är inte alternativ som skolan väljer mellan. När störningen upprepas efterfrågar lagen bådadera.
