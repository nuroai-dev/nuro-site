---
title: "SIP: the plan that coordinates school, healthcare and social services, and why the school is not automatically part of it"
description: "A neurodivergent child often has a school, a BUP assessment and sometimes social services all involved at once, and the family ends up as the only one holding it together. The samordnad individuell plan (SIP) is the statutory tool meant to fix that. Here is what it is, who has the duty to call one, and where the school actually fits."
pubDate: 2026-07-18
