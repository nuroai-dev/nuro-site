...
On 17 March 2026, the Swedish government submitted [proposition 2025/26:195, Förbättrat stöd i skolan](https://www.regeringen.se/contentassets/90deb85eeb924ac4a4b5ef087529f68a/forbattrat-stod-i-skolan-prop.-202526195.pdf) (Improved support in school), to the Riksdag. It proposes changes to the Education Act (skollagen 2010:800) that would reshape how schools are required to give students support. The Riksdag approved the bill on 3 June 2026, and the changes are set to take effect on 1 July 2028. Here is what it actually says.
...
For students with NPF, the detail that matters most is timing. [The outcome gap is already wide](/blog/swedens-parliament-npf-school-results): Parliament's own follow-up found only 62.4 percent of students with NPF reach eligibility for a vocational upper-secondary program, against 87.2 percent of their peers, and that formal särskilt stöd tends to arrive late. A reform built around earlier identification and earlier teaching is, at least on paper, aimed at that timing problem.

But earlier identification only helps if schools can act on it. Knowing in September that a student has fallen behind does not, by itself, give an overstretched teacher the hours to build adapted material for that student. That is [the gap we keep coming back to](/blog/the-right-exists-the-system-doesnt): the distance between what the law asks for and what a teacher can actually deliver for thirty different students at once.

It is also worth being clear about what does not change before 1 July 2028. The current rules, including [extra anpassningar and särskilt stöd as they stand today](/blog/what-skollagen-requires-extra-anpassningar-sarskilt-stod), remain in force until then. A school's obligations to its neurodivergent students do not pause between a reform being decided and taking effect.

Nuro is built for exactly the capacity problem the reform leaves open: giving every student adapted, [Skollagen-aligned support](/blog/what-is-npf-neurodevelopmental-conditions-school) early and by default, without asking a teacher to build thirty versions of every lesson by hand. Whichever legal mechanism the support is delivered under, the work of actually delivering it stays the same. That is the part we build for.

## Update, July 2026: the reform is moving from proposal into practice

Since this was written, the bill has cleared its first steps. Parliament decided on it on 3 June 2026, and on 23 June 2026 the government gave Skolverket a formal assignment to "genomföra insatser för att stödja införandet av skolreformer", to carry out measures that help schools put the reforms into practice. Improved support in school (Förbättrat stöd i skolan) is one of five reforms in that package, alongside new curricula and syllabi, a new grading system, stronger safety and study environment, and new rules on teachers' teaching assignments. Skolverket is to give schools "tydligt och konkret stöd" and to account for the work in stages, with reporting dates of 2 November 2026, 1 June 2027, and a final report by 15 June 2029.

The practical message for schools is that the countdown to 1 July 2028 has started, and preparing for it is now an official mandate rather than a proposal on the table. What does not change is the point above: the duty to actually deliver adapted support to neurodivergent students runs the whole way through, and it does not lighten once the new rules arrive. That is the capacity problem Nuro is built for, whatever the legal mechanism ends up being called.

## Sources

- [Regeringen, "Skolverket får i uppdrag att stödja skolorna inför de stora reformerna" (23 juni 2026)](https://www.regeringen.se/pressmeddelanden/2026/06/skolverket-far-i-uppdrag-att-stodja-skolorna-infor-de-stora-reformerna/)
