...
That is the uncomfortable gap the law cannot close on its own. The duty to investigate begins when absence is already visible. The signal that would let a school act earlier, a student quietly falling behind and disengaging while still in the room, arrives before that, and it is exactly the signal that is hardest to see when [the people best placed to catch it have the least time](/blog/teacher-documentation-burden-and-npf-support).
