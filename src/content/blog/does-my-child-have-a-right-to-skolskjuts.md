---
title: "Does my child have a right to skolskjuts? A funktionsnedsättning is a ground of its own"
description: "Most families assume skolskjuts is about distance. In Skollagen it is not only that. A student's funktionsnedsättning is listed as an independent ground, and a 2023 ruling from Kammarrätten i Stockholm set out what actually decides the question: the journey's effect on the student's wellbeing and their ability to take part in school."
pubDate: 2026-07-25
...
When that pattern repeats, it rarely gets named as a transport problem. It shows up as lateness, as [behaviour that gets read as defiance](/blog/trygghet-och-studiero-when-behaviour-is-a-signal), or as the [early absence that hardens over time](/blog/school-absence-starts-earlier). A journey a child cannot manage is an access problem, and access is what the transport rule exists to protect.
...
Worth knowing before you write, because it tells you what a win would actually get you. The same practical logic applies to [appealing a särskilt stöd decision](/blog/how-to-appeal-a-sarskilt-stod-decision).
...
Note what that list is not. It is not a request to prove the diagnosis. Under the court's test the question is the journey's effect on wellbeing and participation, so that is what the evidence should describe. The right to support in Swedish school [does not hang on a diagnosis](/blog/support-without-a-diagnosis-school), and neither does this.

## Where Nuro fits

Nuro does not arrange transport. What it does is make the evidence for this kind of assessment exist.

The weakness in most applications is that the school day is remembered rather than recorded. Nobody can say how often the student arrived unable to start, or which weeks the absence clustered. When how a student's day actually goes is captured continuously, as [documentation that accumulates rather than being reconstructed](/blog/teacher-documentation-burden-and-npf-support) at the moment it is needed, a family and a school can describe the pattern instead of asserting it. That is the difference between a claim and a case, whether the decision is about transport, [extra anpassningar or särskilt stöd](/blog/what-skollagen-requires-extra-anpassningar-sarskilt-stod).
