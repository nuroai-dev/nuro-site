---
title: "Does my child have a right to an elevassistent?"
description: "Swedish parents often ask whether their child is entitled to a student assistant (elevassistent). The honest legal answer: a child has a right to have their need for support met, but not a right to demand one specific measure. Here is what Skollagen actually says, and why it matters."
pubDate: 2026-07-19
...
That is the same logic that runs through the rest of the support system. The right to support does not [depend on a diagnosis](/blog/support-without-a-diagnosis-school); it depends on assessed need. And the need itself is established through a formal [utredning av elevens behov av särskilt stöd](/blog/the-utredning-behind-sarskilt-stod), not through a request for a particular resource.
...
- Ask for the decision in writing. If the school decides on särskilt stöd, that must be documented in an [åtgärdsprogram](/blog/what-an-atgardsprogram-must-contain) that states the need and the measures. If the school decides an elevassistent is not the right measure, you are entitled to know what it will do instead.
...
- [Skolverket, "Utredning av en elevs behov av särskilt stöd"](https://www.skolverket.se/4.5e6fbba7183ff3c498240e5.html)
