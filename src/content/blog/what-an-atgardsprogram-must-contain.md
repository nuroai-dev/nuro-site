---
title: "What an åtgärdsprogram must actually contain, and where they most often fall short"
description: "When a Swedish student needs särskilt stöd, the school documents it in an åtgärdsprogram. Skollagen sets out exactly four things it must contain, and Skolinspektionen keeps finding the same gaps. Here is what belongs in the document, what does not, and why getting it right is the difference between support on paper and support in the classroom."
pubDate: 2026-07-07
...
Under [chapter 3, section 9 of Skollagen, as set out by Skolverket](https://www.skolverket.se/styrning-och-ansvar/regler-och-ansvar/ansvar-i-skolfragor/extra-anpassningar-sarskilt-stod-och-atgardsprogram), an åtgärdsprogram must state:
