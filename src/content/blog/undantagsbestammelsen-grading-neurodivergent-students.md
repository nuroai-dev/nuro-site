---
title: "When a disability blocks one grading criterion, can the teacher still set the grade?"
description: "Yes. Swedish law has a specific rule, undantagsbestämmelsen, often nicknamed pysparagrafen, that lets a teacher disregard isolated parts of the grade criteria a student cannot meet because of a lasting disability. Here are the three conditions, where it applies, and where it does not."
pubDate: 2026-07-14
...
So the national tests are not "pysed." What a student with dyslexia or ADHD can get on the national tests is an adaptation of how they sit the test, decided by the principal, which is a [separate rule with its own logic](/blog/adapting-national-tests-for-neurodivergent-students). The exemption is what can come later, at the moment the final grade is set.
...
Nuro does not set grades, and it should not. What it does is keep that per-student picture current and legible: how the student learns, what adaptations are in place, what they can show they know when the format works for them. That is exactly the ground a sound undantagsbestämmelsen judgement stands on, and it is the same picture that the [utredning behind särskilt stöd](/blog/the-utredning-behind-sarskilt-stod) and the [documentation Skollagen already requires](/blog/what-skollagen-requires-extra-anpassningar-sarskilt-stod) are meant to hold. The right to a fair grade exists. Making it easy for a teacher to apply it well is the part still being built. For students moving from grundskola to gymnasiet, [the same framework continues](/blog/npf-support-rights-gymnasium): both the support provisions and the undantagsbestämmelsen carry forward, while the stakes on each grade rise.

## Sources

- [Skolverket, "Undantagsbestämmelsen vid betygssättning"](https://www.skolverket.se/prov-och-bedomning/betyg/undantagsbestammelsen-vid-betygssattning)
