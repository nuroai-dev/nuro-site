---
title: "How to report a school to Skolinspektionen when your child is not getting support"
description: "If a school will not give your child the support they are entitled to, and talking to the teacher and rektor has not worked, you can report it. Here is the order Sweden's own authorities recommend, what Skolinspektionen actually does with a report, and how this route differs from appealing a decision or filing a discrimination claim."
pubDate: 2026-07-23
...
1. **Start with the teacher or the rektor.** Skolverket is plain about this: "Det mest effektiga är att vända sig till personalen eller rektorn", the most effective thing is to turn to the staff or the rektor ([Skolverket](https://www.skolverket.se/om-skolverket/kontakta-skolverket/kontaktvagar-vid-brister-eller-missforhallanden-i-skolan)). Most problems are meant to be solved here.
2. **Then the huvudman.** If the rektor has not resolved it, you take a formal complaint to the huvudman, the operator: the municipality for a kommunal school, or the company or foundation behind an independent one. This is not optional goodwill on their part. Under Skollagen, "alla huvudmän inom skolväsendet ska ha skriftliga rutiner för att ta emot och utreda klagomål mot utbildningen", every huvudman must have a written routine for receiving and investigating complaints. Ask for that routine and use it.
3. **Then Skolinspektionen and BEO.** Only "om du fortsatt upplever brister" after the huvudman has had its chance do you turn to Skolinspektionen. Reaching this step is stronger when you can show you already went through the first two.
...
- **[Appeal a decision](/blog/how-to-appeal-a-sarskilt-stod-decision):** when the school has made a specific appealable decision, such as refusing an åtgärdsprogram, you can appeal it to Skolväsendets överklagandenämnd and get an individual ruling. This is the route for a fast, personal outcome.
- **[Discrimination claim](/blog/failing-to-support-npf-student-can-be-discrimination):** when the failure to make reasonable adjustments amounts to unlawful discrimination, a separate track under Diskrimineringslagen with its own compensation.
